...
public class Upload_Video extends BaseActivity {
    ImageView playerView,ivStatus,profileImage,back;
    SimpleExoPlayer exoPlayer;
    private String miUrlOk = "",sTitle="",imageUrl="";
    ...
    private void uploadVideo(String upload_video, Bitmap bittMap) {
       ...
       /* path.putFile(Uri.parse(upload_video)).addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
            @Override
