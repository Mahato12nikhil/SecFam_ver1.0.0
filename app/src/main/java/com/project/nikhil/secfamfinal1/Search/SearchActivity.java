package com.project.nikhil.secfamfinal1.Search;
...
public class SearchActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Client client = new Client("09FYDDE3SU", "6c7231f5e9edd4801d60cb4e5c75176f");
    ...
    private void parseJsonObject(JSONObject responseJsonObject) throws JSONException {
        ...
        for (int i=0; i< marketCapArray.length(); i++){
            ...
            User user=new User(name,id,image,0,null,null,null,null,null);
            userList.add(user);
