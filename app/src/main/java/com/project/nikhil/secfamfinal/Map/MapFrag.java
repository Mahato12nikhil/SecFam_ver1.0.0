package com.project.nikhil.secfamfinal.Map;
...
import com.project.nikhil.secfamfinal.LocationService.BackgroundMapDataService;
...
public class MapFrag extends Fragment implements OnMapReadyCallback, RoutingListener {
   ...
   // private static TrackuserActivity mInstance;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vitimLocationRef = FirebaseDatabase.getInstance().getReference("TrackLocation").child("W2NF6jQZ1weolyDl6dKYXgONPbj1").child("l");
        ...
        route.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(oldLatLong!=null)
                {
                    ...
                    intent1.putExtra("userID","W2NF6jQZ1weolyDl6dKYXgONPbj1");
    ...
    private void getRouteToMarker(LatLng pickupLatLng) {
        ...
        if (pickupLatLng != null ) {
            routing = new Routing.Builder()
                    ...
                    .key("AIzaSyBIL2KJQrPXoNicA1rhQ4GKVlxk3wkIMeo")
