...
public class ShowAlIPostmages extends AppCompatActivity {
      ...
      /*  back.setOnClickListener(new View.OnClickListener() {
        ...
        String postId=getIntent().getStringExtra("postid");
          ...
          list= (ArrayList<String>) getIntent().getSerializableExtra("links");;
           if(list!=null){
               final AllPostAdapter mainAdapter = new AllPostAdapter (ShowAlIPostmages.this,list);
               ...
               databaseReference.addValueEventListener(new ValueEventListener() {
                   ...
                   public void onDataChange(@NonNull DataSnapshot snapshot) {
                       ...
                       final AllPostAdapter mainAdapter = new AllPostAdapter (getApplicationContext(),list );
                       recyclerView.setAdapter (  mainAdapter);
                       mainAdapter.notifyDataSetChanged();
                   }
