...
public class Emergency_Notification extends Fragment {
    ...
    private List<Emergency_data> noteList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mConvDatabase = FirebaseDatabase.getInstance().getReference().child("EmergencyUsersChat");
        ...
        bhugy=view.findViewById(R.id.bhugy);
        ...
        messageReceivedAdapter=new EmergencyNotificationAdapter(getContext());
    ...
    private void readNotification() {
        ...
        if (!isMaxDat) {
            ...
            if(TextUtils.isEmpty(lastNode))
            {
                ...
                query=mConvDatabase .child("EmergencyUsersChat").
                        child(FirebaseAuth.getInstance().getCurrentUser().getUid())
                        .child("receive")
                        .orderByKey()
                        .endAt(lastNode)
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.hasChildren()) {
                        ...
                        messageReceivedAdapter.addAll(noteList);
                        isScrollin=false;
