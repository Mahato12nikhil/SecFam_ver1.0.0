...
public class EmergencyNotificationAdapter extends RecyclerView.Adapter<EmergencyNotificationAdapter.Holder> {
    ...
    String name;
    public EmergencyNotificationAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull final EmergencyNotificationAdapter.Holder holder, final int position) {
       ...
       Emergency_data emrNotify=noteList.get(position);
        ...
        if(emrNotify!=null) {
            getDetails(holder.user_name, holder.dpDal, holder.time, emrNotify.getSender());
    ...
    private void getDetails(final   TextView user_name, final CircleImageView dpDal, TextView time, String sender) {
      ...
      //  Toast.makeText(context,""+sender,Toast.LENGTH_LONG).show();
        ...
        mUsersDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    Glide.with(context).load(dataSnapshot.child("image").getValue().toString()).into(dpDal);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    private void background(final RelativeLayout itemview, String s) {
      ...
      //  Toast.makeText(context,"entered",Toast.LENGTH_LONG).show();
        ...
        final DatabaseReference reference= FirebaseDatabase.getInstance().getReference().child("EmergencyUsersChat")
